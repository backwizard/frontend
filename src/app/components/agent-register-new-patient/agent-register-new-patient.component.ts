...
@Component({
  selector: 'app-agent-register-new-patient',
  templateUrl: './agent-register-new-patient.component.html',
  styleUrls: ['./agent-register-new-patient.component.css']
})
export class AgentRegisterNewPatientComponent implements OnInit {
